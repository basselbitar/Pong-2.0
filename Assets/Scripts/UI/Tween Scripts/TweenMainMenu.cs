...
public class TweenMainMenu : MonoBehaviour
{
    ...
    vibrToggle, BackButton, BackPanel, StartMenuPanel, OptionsPanel;
    ...
    public void Back()
    {
        ...
        LeanTween.scale(BackButton, new Vector3(0f, 0f, 0f), 0.6f).setDelay(.3f).setEase(LeanTweenType.easeInQuart).setOnComplete(OptionsActivateFalse);

        TweenMainMenuButtons();
    }
    ...
    void PlayTween()
    {
        ...
        .setOnComplete(() => { Debug.Log("Play has been played"); });
